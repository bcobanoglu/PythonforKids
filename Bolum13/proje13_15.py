...
Proje 13_15: Türk Bayrağı Çizimi
"""
from turtle import *
...
#Ana program
renkveKonum("white",-110,-120) #renkveKonum çağrıldı
ay(130) #beyaz daire çizelim
renkveKonum("red", -70, -90) #renkveKonum çağrıldı:
...
mainloop()#Çizim ekranının kaybolmaması için mainloopu hep çağıralım.